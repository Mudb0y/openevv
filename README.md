...
That wants a C compiler and about half a minute. On Linux nothing plays the audio yet, so the engine writes a wave file; pipe it into a player to hear it at once:
