...
"            44100 hertz. Above 11025 the engine still runs at 8000 or\n"
"            11025 and each sample is repeated, which is what keeps the\n"
"            voice sounding like Eloquence. A number of 8000 or more is\n"
"            that rate in hertz, synthesised outright; EVV_UPSAMPLE=none\n"
"            does that for the settings above too, for comparison\n"
