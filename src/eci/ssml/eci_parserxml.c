 ...
 *
 * The scanner in src/eci/ssml/eci_xmltok.c is flex's, and flex keeps its state in
 ...
 * reads one byte at a time; see src/eci/ssml/eci_mbconvert.c for what narrowing is.
