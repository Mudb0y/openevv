 ...
 * handler in src/eci/ssml/eci_ssmlprocessor.c writes through, and the buffer doubles
 ...
 * exactly full invalid -- see src/eci/ssml/eci_ssmlintstack.c -- so the twentieth
