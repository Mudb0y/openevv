 ...
 *
 * src/eci/ssml/eci_ssmlstate.c is the whole of it, with the five say-as counters in
 * src/eci/ssml/eci_ssmlsayas.c beside it because that is how IBM's objects divide.
 * The tag handlers in src/eci/ssml/eci_ssmlprocessor.c write through nothing else.
 */
...
/* The five say-as counters, in src/eci/ssml/eci_ssmlsayas.c. */
