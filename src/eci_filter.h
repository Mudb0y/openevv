 ...
 * src/eci_filtermanager.c does the rest.
 *
 ...
 * on it slot for slot.
 *
 * src/eci_filter.c is the base every filter inherits, which does nothing
 * but remember whether it is on. src/eci_ssmlfilter.c is the one filter
 * IBM shipped.
 */
