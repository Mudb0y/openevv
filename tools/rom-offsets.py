...
def regions_ds(d):
    ...
    r = [
        ...
        (d["DS_TANKAN"], d["DS_TANKAN_N"] * d["DS_TANKAN_SIZE"],
         "the tankan table"),
        (d["DS_KANA"], d["DS_KANA_N"] * d["DS_KANA_SIZE"], "the kana buffers"),
        (d["DS_W_847A"], 2, "a word"),
        (d["DS_UNREAD_KANA"], d["DS_UNREAD_KANA_END"] - d["DS_UNREAD_KANA"],
         "what follows the kana buffers, unread"),
        (d["DS_WORK"], d["DS_WORK2"] - d["DS_WORK"], "the first working area"),
        (d["DS_WORK2"], d["DS_WORK_END"] - d["DS_WORK2"],
